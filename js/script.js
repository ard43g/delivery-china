    ...
    function menuMain() {
        ...
        burger.addEventListener("click", (e) => {
            ...
            if (target.classList.contains("active")) {
                burger.classList.remove("active"), menu.classList.remove("active"), (document.body.style.overflow = "");
            } else {
                burger.classList.add("active"), menu.classList.add("active"), (document.body.style.overflow = "hidden");
            }
        });
    }
